...
const weightOutwardSchema = new mongoose.Schema({
    RSTNo: {
        unique:true,
        type: Number
    },
...
weightOutwardSchema.pre('save', async function (next) {
    try {
...
const WeightOutward = mongoose.model("WeightOutward", weightOutwardSchema)
module.exports = WeightOutward
